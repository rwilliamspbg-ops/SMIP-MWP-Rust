...
#[inline(never)]
fn miss_lookup(table: &Table, src_id: [u8; 32], dst_id: [u8; 32], flow_label: u32) -> Option<[u8; 32]> {
...
fn routing_miss_benchmark(c: &mut Criterion) {
    ...
    for &route_count in ROUTE_COUNTS {
        ...
        group.bench_with_input(BenchmarkId::new("lookup_or_predict_miss", route_count), &route_count, |b, _| {
            b.iter(|| {
